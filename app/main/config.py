...
SQLITE_DEV = 'mssql+pymssql://'+SQL_SERVER+':'+SQL_PORT+'/'+SQL_DATABASE
SQLITE_PROD = 'mssql+pymssql://'+SQL_SERVER+':'+SQL_PORT+'/'+SQL_DATABASE
SQLITE_TEST = 'mssql+pymssql://'+SQL_SERVER+':'+SQL_PORT+'/'+SQL_DATABASE
