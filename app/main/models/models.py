...
class OmpBaru(db.Model):
    ...
    domestic_category = db.Column(db.String(255), nullable=True)
    domestic_freq = db.Column(db.String(255), nullable=True)
    domestic_rate = db.Column(db.String(255), nullable=True)
    domestic_total = db.Column(db.String(255), nullable=True)
    pukal_category = db.Column(db.String(255), nullable=True)
    pukal_freq = db.Column(db.String(255), nullable=True)
    pukal_rate = db.Column(db.String(255), nullable=True)
    pukal_total = db.Column(db.String(255), nullable=True)

    sapuan_domestic_unit = db.Column(db.String(255), nullable=True)
    sapuan_domestic_rate = db.Column(db.String(255), nullable=True)
    sapuan_domestic_freq = db.Column(db.String(255), nullable=True) 
    sapuan_komersial_unit = db.Column(db.String(255), nullable=True) 
    sapuan_komersial_rate = db.Column(db.String(255), nullable=True) 
    sapuan_komersial_freq = db.Column(db.String(255), nullable=True) 

    cucian_domestic_unit = db.Column(db.String(255), nullable=True) 
    cucian_domestic_rate = db.Column(db.String(255), nullable=True) 
    cucian_domestic_freq = db.Column(db.String(255), nullable=True) 
    cucian_komersial_unit = db.Column(db.String(255), nullable=True) 
    cucian_komersial_rate = db.Column(db.String(255), nullable=True) 
    cucian_komersial_freq = db.Column(db.String(255), nullable=True) 
    cucian_drain_domestic_unit = db.Column(db.String(255), nullable=True) 
    cucian_drain_domestic_rate = db.Column(db.String(255), nullable=True) 
    cucian_drain_domestic_freq = db.Column(db.String(255), nullable=True) 
    cucian_drain_komersial_unit = db.Column(db.String(255), nullable=True) 
    cucian_drain_komersial_rate = db.Column(db.String(255), nullable=True) 
    cucian_drain_komersial_freq = db.Column(db.String(255), nullable=True) 
    cucian_jejantas_dalam_unit = db.Column(db.String(255), nullable=True) 
    cucian_jejantas_dalam_rate = db.Column(db.String(255), nullable=True) 
    cucian_jejantas_dalam_freq = db.Column(db.String(255), nullable=True) 
    cucian_jejantas_atas_unit = db.Column(db.String(255), nullable=True) 
    cucian_jejantas_atas_rate = db.Column(db.String(255), nullable=True) 
    cucian_jejantas_atas_freq = db.Column(db.String(255), nullable=True) 
    cucian_siar_roof_unit = db.Column(db.String(255), nullable=True) 
    cucian_siar_roof_rate = db.Column(db.String(255), nullable=True) 
    cucian_siar_roof_freq = db.Column(db.String(255), nullable=True) 
    cucian_siar_gulam1_unit = db.Column(db.String(255), nullable=True) 
    cucian_siar_gulam1_rate = db.Column(db.String(255), nullable=True) 
    cucian_siar_gulam1_freq = db.Column(db.String(255), nullable=True) 
    cucian_siar_gulam2_unit = db.Column(db.String(255), nullable=True) 
    cucian_siar_gulam2_rate = db.Column(db.String(255), nullable=True) 
    cucian_siar_gulam2_freq = db.Column(db.String(255), nullable=True) 
    cucian_tandas_unit = db.Column(db.String(255), nullable=True) 
    cucian_tandas_rate = db.Column(db.String(255), nullable=True) 
    cucian_tandas_freq = db.Column(db.String(255), nullable=True) 
    cucian_teksi_rate = db.Column(db.String(255), nullable=True) 
    cucian_teksi_freq = db.Column(db.String(255), nullable=True) 
    cucian_teksi_total = db.Column(db.String(255), nullable=True) 

    bersih_lapang_unit = db.Column(db.String(255), nullable=True) 
    bersih_lapang_rate = db.Column(db.String(255), nullable=True) 
    bersih_lapang_freq = db.Column(db.String(255), nullable=True)
    bersih_tpkk_unit = db.Column(db.String(255), nullable=True)
    bersih_tpkk_freq = db.Column(db.String(255), nullable=True)
    bersih_tpkk_rate = db.Column(db.String(255), nullable=True)
    bersih_penjaja_unit = db.Column(db.String(255), nullable=True)
    bersih_penjaja_rate = db.Column(db.String(255), nullable=True)
    bersih_penjaja_freq = db.Column(db.String(255), nullable=True)
    bersih_pasar_unit = db.Column(db.String(255), nullable=True)
    bersih_pasar_rate = db.Column(db.String(255), nullable=True)
    bersih_pasar_freq = db.Column(db.String(255), nullable=True)
    bersih_pasar_mlm_unit = db.Column(db.String(255), nullable=True)
    bersih_pasar_mlm_rate = db.Column(db.String(255), nullable=True)
    bersih_pasar_mlm_freq = db.Column(db.String(255), nullable=True)

    rumput_unit = db.Column(db.String(255), nullable=True)
    rumput_rate = db.Column(db.String(255), nullable=True)
    rumput_freq = db.Column(db.String(255), nullable=True)
...
class EMeeting(db.Model):
    ...
    jenis_jawatankuasa = db.Column(db.String(250))
    jenis_mesyuarat = db.Column(db.String(250))
    jabatan_terlibat = db.Column(db.String(250))
    tarikh_mesyuarat = db.Column(db.String(250))
    ...
    tajuk_mesyuarat = db.Column(db.String(250))
    setiausaha = db.Column(db.String(250))
    tempat_mesyuarat = db.Column(db.String(250))
...
class OfficersList(db.Model):
    ...
    no_ic_pegawai=db.Column(db.String(100), nullable=True)
...
class Inquiry(db.Model):
    ...
    masa_siasatan=db.Column(db.String(100), nullable=True)
    lokasi_siasatan=db.Column(db.String(500), nullable=True)
    laporan_siasatan=db.Column(db.String(500), nullable=True)
    tindakan=db.Column(db.String(500), nullable=True)
    susulan=db.Column(db.String(500), nullable=True)
    ullasan_penyelia=db.Column(db.String(500), nullable=True)
    ullasan_ketua_seksyen=db.Column(db.String(500), nullable=True)
    ullasan_ketua_unit=db.Column(db.String(500), nullable=True)
    ulasan_timbalan=db.Column(db.String(500), nullable=True)
    inserted_date = db.Column(db.Date, nullable=True)
    updated_date = db.Column(db.Date, nullable=True)
    inserted_by = db.Column(db.String(30), nullable=True)
    updated_by = db.Column(db.String(30), nullable=True)
    active = db.Column(db.Boolean, default=1)
    inquiry_type = db.Column(db.String(50), nullable=True)
    jenis_kawasan=db.Column(db.String(255), nullable=True)
    picture1=db.Column(db.String(255), nullable=True)
    picture2=db.Column(db.String(255), nullable=True)
    picture3=db.Column(db.String(255), nullable=True)
...
class ComplaintInvestigation(db.Model):
    ...
    nama_pegawai=db.Column(db.String(100), nullable=True)
    no_ic_pegawai_mtk=db.Column(db.String(100), nullable=True)
    no_ic_pegawai=db.Column(db.String(100), nullable=True)
    id_mtb=db.Column(db.String(50))
