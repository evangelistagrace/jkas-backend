...
def getAnnouncement(language):
    try:
        ...
        for announce in PublicAnnouncement.query.filter(PublicAnnouncement.language == language, PublicAnnouncement.active == 1).order_by(desc(PublicAnnouncement.date)):
